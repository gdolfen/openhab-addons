...
/**
 * Handles Key Control Command Left.
 *
 * @author Guido Dolfen
 */
@NonNullByDefault
public class KeyControlLeft extends BaseChannelHandler<Void, Object> {
    ...
    public void onReceiveCommand(@Nullable ConnectableDevice device, String channelId, LGWebOSHandler handler,
        ...
        if (device.hasCapabilities(KeyControl.Left)) {
            getControl(device).left(getDefaultResponseListener());
        }
    }
}
