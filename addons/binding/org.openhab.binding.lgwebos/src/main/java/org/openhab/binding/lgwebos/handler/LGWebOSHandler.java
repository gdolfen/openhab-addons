...
import org.openhab.binding.lgwebos.internal.KeyControlBack;
import org.openhab.binding.lgwebos.internal.KeyControlDown;
import org.openhab.binding.lgwebos.internal.KeyControlHome;
import org.openhab.binding.lgwebos.internal.KeyControlLeft;
import org.openhab.binding.lgwebos.internal.KeyControlOk;
import org.openhab.binding.lgwebos.internal.KeyControlRight;
import org.openhab.binding.lgwebos.internal.KeyControlUp;
...
public class LGWebOSHandler extends BaseThingHandler implements ConnectableDeviceListener, DiscoveryManagerListener {
    ...
    public LGWebOSHandler(@NonNull Thing thing, DiscoveryManager discoveryManager) {
        ...
        handlers.put(CHANNEL_KEY_HOME, new KeyControlHome());
        handlers.put(CHANNEL_KEY_BACK, new KeyControlBack());
        handlers.put(CHANNEL_KEY_DOWN, new KeyControlDown());
        handlers.put(CHANNEL_KEY_LEFT, new KeyControlLeft());
        handlers.put(CHANNEL_KEY_OK, new KeyControlOk());
        handlers.put(CHANNEL_KEY_RIGHT, new KeyControlRight());
        handlers.put(CHANNEL_KEY_UP, new KeyControlUp());
