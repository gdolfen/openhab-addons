...
/**
 * Handles Key Control Command Up.
 *
 * @author Guido Dolfen
 */
@NonNullByDefault
public class KeyControlUp extends BaseChannelHandler<Void, Object> {
    ...
    public void onReceiveCommand(@Nullable ConnectableDevice device, String channelId, LGWebOSHandler handler,
        ...
        if (device.hasCapabilities(KeyControl.Up)) {
            getControl(device).up(getDefaultResponseListener());
        }
    }
}
