...
/**
 * Handles Key Control Command Home.
 *
 * @author Guido Dolfen
 */
@NonNullByDefault
public class KeyControlHome extends BaseChannelHandler<Void, Object> {
    ...
    public void onReceiveCommand(@Nullable ConnectableDevice device, String channelId, LGWebOSHandler handler,
        ...
        if (device.hasCapabilities(KeyControl.Home)) {
            getControl(device).home(getDefaultResponseListener());
        }
    }
}
